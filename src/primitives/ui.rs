...
pub const FONT_REGULAR: &str = "fonts/TerminessNerdFont-Regular.ttf";

// colors
pub const NORMAL_BUTTON: Color = Color::rgb(1.0, 1.0, 1.0);
pub const HOVERED_BUTTON: Color = Color::rgb(0.92, 0.92, 0.92);
pub const PRESSED_BUTTON: Color = Color::rgb(0.75, 0.75, 0.75);
